...
api_gemini_docker<br>
 Segunda versão do projeto chat, está funcionando com o minimo para funcionar usa flask para o backend e vita para o frontend. Atualmente está quebrada.<br>
api_ia_web<br>
